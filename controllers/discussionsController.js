...
/**
  ...
  create: (req, res, next) => {
    ...
    .catch((error) => {
      console.log(`Error Create Discussion!: ${error.message}`);
      next(error);
    });
  },
  ...
  index: (req, res, next) => {
    Discussion.find()
      ...
      .catch((error) => {
        ...
        console.log(`Error fetching Discusse: ${error.message}`);
  ...
  show: (req, res, next) => {
    ...
    .catch((error) => {
      console.log(`Error fetching author by ID: ${error.message}`);
  ...
  update: (req, res, next) => {
    ...
    .then((discussions) => {
      res.locals.redirect = `/discussions`;
      res.locals.discussion = discussions;
      next();
    })
    .catch((error) => {
      console.log(`Error: ${error.message}`);
